...
const FILTERS = [
  { id: "*", label: "SHOW ALL" },
  { id: ".cat1", label: "AGENCY" },
  { id: ".cat2", label: "Visual" },
  { id: ".cat3", label: "SHOOTING" },
  { id: ".cat4", label: "STUDIO" },
] as const;
        ...
        <div className="nt-grid nt-grid-cols-1 md:nt-grid-cols-2 nt-gap-8">
          {portfolio_data.map((item) => (
            <div key={item.id} className={`grid-item ${item.show}`}>
              <div
                className="tp-project-5-2-thumb anim-zoomin-wrap not-hide-cursor nt-relative"
              ...
              >
                ...
                >
                  <Image
                    className="anim-zoomin nt-w-full nt-h-[660px] nt-object-cover"
                    src={item.img}
                    alt="port-img"
                  />
