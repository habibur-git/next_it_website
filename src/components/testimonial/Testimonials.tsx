    ...
    <section className="nt-space">
      <div className="nt-container nt-mx-auto nt-px-4">
        ...
        <div className="nt-flex nt-flex-col md:nt-flex-row md:nt-items-center md:nt-justify-between nt-gap-6 nt-mb-16">
          ...
          {/* Custom Arrows */}
          <div className="nt-flex nt-justify-center md:nt-justify-end nt-gap-3">
            <button
              onClick={() => swiperRef.current?.slidePrev()}
              className="nt-w-16 nt-h-16 nt-text-white nt-text-[24px] nt-font-bold nt-rounded-full nt-border nt-border-border/90 hover:nt-bg-theme hover:nt-text-white nt-transition nt-cursor-pointer nt-bg-bg"
        ...
        >
          {testimonialData.map((item, index) => (
            <SwiperSlide key={index}>
              <motion.div
                className="nt-rounded-3xl nt-p-6 md:nt-p-8 nt-h-full black-bg"
